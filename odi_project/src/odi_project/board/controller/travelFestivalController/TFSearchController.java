 ...
 */
//여행지&축제 페이지 검색기능
@WebServlet("/tfsearch.bo")
public class TFSearchController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /** @see HttpServlet#HttpServlet() */
    public TFSearchController() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int searchCount = boardservice.searchTravelListCount(map); //현재 검색결과에 맞는 게시글의 총 갯수
		...
		ArrayList<TravelFestival> list = boardservice.searchTraveList(map,pi);
