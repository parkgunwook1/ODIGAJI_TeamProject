...
//		int currentPage = Integer.parseInt(request.getParameter("currentPage"));
		...
		ArrayList<Board> noticeList = service.noticeSelectList(pi);
		
		request.setAttribute("pi", pi);
		request.setAttribute("noticeList", noticeList);
		
		request.getRequestDispatcher("WEB-INF/views/board/noticeBoard/noticeboardlistview.jsp").forward(request, response);
