...
<body>
	...
	<main>
		<div class="outer">
			<br> <span class="general-board-title">일반 게시판 작성</span>

			<form action="insertboard.bo" class="board-content" method="post">
				...
				<table class="general-board-content">
					<tr>
						...
						<select name="categoryNo">
								<option value="B4">자유</option>
								<option value="B3">문의</option>
								<option value="B1">맛집/카페</option>
								<option value="B2">여행/축제</option>
					...
					<tr>
						...
						<td><input type="text" name="boardTitle" required
							value="${b.boardTitle}" placeholder="제목을 입력하세요."></td>
					</tr>
					<tr>
						<div>
							...
							<textarea name="boardContent" id="content" rows="20"
									cols="80" maxlength="1000" oninput="calc()" required
				...
				<div class="board-button">
					...
					<button type="button" onclick="location.href='commonlist.bo?bno=1'">취소</button>
