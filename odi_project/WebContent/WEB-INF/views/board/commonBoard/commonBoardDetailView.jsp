	...
	<div class="container">
		...
		<div class="head">
			<div class="head_title">
				<h1 class="title">${b.boardTitle}</h1>
			</div>
			<div class="headinfo">
				<div class="writer">
					<span>작성자 : ${b.memberId}</span>
				</div>
				<div class="createdate">
					<span>작성일 : ${b.createDate}</span>
				</div>
				<div class="viewctn">
					<span class="material-symbols-outlined"> visibility </span> <span>${b.count}</span>
				</div>
				<c:if test="${b.memberId.equals(loginUser.memberId)}">
					<div class="boardCtrl">
						<form action="boardUpdateForm.bo" method="post" style="margin-right: 2px;">
			...
			<div class="reply_view">
				...
				<table class="replyTable" align="center" border="1">
					<form action="insertReply.bo" method="post">
						...
						<tr>
							...
							<th width="100"><button type="submit"
									class="replySubmitButton">등록</button></th>
						</tr>
					...
					<tr>
						...
						<td colspan="2">
							<b>댓글<span class="replyCount">${list.size()}</span></b>
						</td>
					</tr>
								...
								<tr>
									...
									<c:if test="${reply.memberId.equals(loginUser.memberId)}">
										...
										<div class="deleteReply">
											<form action="deleteReply.bo" name="deleteReply"
												method="post">
												<input type="hidden" name="bno" value="${param.bno }">
...
<!--FOOTER-->
  <footer style = "bottom : -400px; width : 100%" >
    <div class="inner">
      <div class="items">
	...
	<div id="updateModal" class="modal">
		<div class="modal-content">
			...
			<h2>댓글 수정</h2>
			<form action="updateReply.bo" method="post" name="updateForm">
